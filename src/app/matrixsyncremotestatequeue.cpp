...
void MatrixSyncRemoteStateQueue::append(const Quotient::StateEvent &state, const QString &roomId)
{
...
void MatrixSyncRemoteStateQueue::addKnownEventId(const QString &eventId)
{
