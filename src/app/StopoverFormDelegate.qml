    ...
    contentItem: GridLayout {
        ...
        ColumnLayout {
            ...
            Flow {
                ...
                QQC2.Label {
                    text: (expectedTimeLabel.visible ? ' · ' : '') + i18nc("@info", "Platform %1", delegateRoot.stopover.hasExpectedPlatform ? delegateRoot.stopover.expectedPlatform : delegateRoot.stopover.scheduledPlatform)
                    color: delegateRoot.stopover.platformChanged ? Kirigami.Theme.negativeTextColor : Kirigami.Theme.textColor
                    visible: delegateRoot.stopover.scheduledPlatform.length > 0
