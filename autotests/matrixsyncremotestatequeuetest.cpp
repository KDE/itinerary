...
class MatrixSyncRemoteStateQueueTest : public QObject
{
    Q_OBJECT
private Q_SLOTS:
    void initTestCase()
    ...
    void testQueue()
    {
        MatrixSyncRemoteStateQueue q;
        QSignalSpy downloadSpy(&q, &MatrixSyncRemoteStateQueue::downloadFile);
        QSignalSpy reservationSpy(&q, &MatrixSyncRemoteStateQueue::reservationEvent);
        QSignalSpy documentSpy(&q, &MatrixSyncRemoteStateQueue::documentEvent);
        QSignalSpy transferSpy(&q, &MatrixSyncRemoteStateQueue::transferEvent);
...
QTEST_GUILESS_MAIN(MatrixSyncRemoteStateQueueTest)

#include "matrixsyncremotestatequeuetest.moc"
